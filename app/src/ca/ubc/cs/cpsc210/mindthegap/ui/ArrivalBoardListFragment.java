...
public class ArrivalBoardListFragment extends ListFragment {
    ...
    public ArrayList<ArrivalBoard> getArrivalBoardsForSelectedStation() {
        ...
        Iterator<ArrivalBoard> iterableBaords = selected.iterator();
        ArrayList<ArrivalBoard> selectedBoards = new ArrayList<>();

        while (iterableBaords.hasNext()) {
            selectedBoards.add(iterableBaords.next());
        }
